...
angular.module("umbraco").controller("uCondition.PredicateGroup", ["$scope", "$timeout", "editorService", "navigationService", uCondition.Editor.Controllers.PredicateGroupController]);
angular.module("umbraco").controller("uCondition.Dialogs.AddCondition", ["$scope", "editorService", "navigationService", "uConditionApiService", uCondition.Editor.Controllers.AddConditionDialog]);
