...
(function (uConditionPublicAccess) {
    ...
    (function (Controllers) {
        var PublicAccessController = (function () {
            function PublicAccessController($scope, publicAccessService, dialogService, treeService, navigationService, notificationsService, $routeParams, contentResource, mediaResource) {
                this.$scope = $scope;
                ...
                resource.getById($routeParams.id).then(function (data) {
                    $scope.currentNode = data;
                    navigationService.syncTree({ tree: $routeParams.section, path: data.path, forceReload: true });
                });
                this.PublicAccessService.GetCondition($routeParams.id).then(function (response) {
...
angular.module("umbraco").controller("uCondition.PublicAccess", ["$scope", "uCondition.PublicAccessService", "dialogService", "treeService", "navigationService", "notificationsService", "$routeParams", "contentResource", "mediaResource", uConditionPublicAccess.Controllers.PublicAccessController]);
...
//# sourceMappingURL=ucondition.publicaccess.js.map